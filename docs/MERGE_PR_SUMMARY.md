...
3) Anchor scheduling flow
   ...
   - Weekly scheduling option for Math (days/time across weeks)
...
5) Recurring + after-hours
   - Create-event dialog supports weekly/custom recurrence
   - After-hours flag shows as note without extending grid
